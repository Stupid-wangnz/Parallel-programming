...
void Simd_AVX_Aligned(float** A)
{
    for(int k=0;k<Arr_size;k++)
    {
        ...
        __m256 vt;
        float temp[8]__attribute__((aligned(32)))={A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k]};
        vt=_mm256_load_ps(temp);
        int j=k+1;
...
void Simd_AVX512(float** A)
{
    for(int k=0;k<Arr_size;k++)
    {
        ...
        for(int i=k+1;i<Arr_size;i++)
        {
            float temp1[16]={A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k]};
            __m512 vaik=_mm512_loadu_ps(temp1);
            for(j=k+1;j+16<=Arr_size;j+=16)
            {
...
void Simd_AVX512_Aligned(float** A)
{
    for(int k=0;k<Arr_size;k++)
    {
        ...
        //float temp[16]__attribute__((aligned(64)))={A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k],A[k][k]};
        ...
        for(int i=k+1;i<Arr_size;i++)
        {
            float temp1[16]__attribute__((aligned(64)))={A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k],A[i][k]};
...
void Run()
{
    ...
    for(int i=0;i<Arr_size;i++)
       {
            Aligned_Gauss_arr[i]=(float*)_aligned_malloc(Arr_size*4,512);
